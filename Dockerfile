...
COPY ./requirements.txt /azimuth-schedule-operator/requirements.txt
RUN pip install -U pip setuptools
RUN pip install --requirement /azimuth-schedule-operator/requirements.txt

COPY . /azimuth-schedule-operator
RUN pip install /azimuth-schedule-operator
